              ...
              <>
                ...
                {user.user_type === 'freelancer' && (
                  <>
                    ...
                    <Link to="/portfolio" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">
                      Portfolio
                    </Link>
                  </>
                )}
                ...
                {isAdmin && (
                  <Link to="/admin" className="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-medium">
                    ⚙️ Admin
                  </Link>
                )}
