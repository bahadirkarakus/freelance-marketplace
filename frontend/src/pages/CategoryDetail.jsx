...
const CategoryDetail = () => {
  ...
  const categoryData = {
    ...
    admin: {
      title: 'Admin & Support',
      subtitle: 'Virtual assistants, customer support and administrative professionals',
    ...
    finance: {
      ...
      subtitle: 'Expert financial consultants, accountants and bookkeepers',
      color: 'from-yellow-500 to-amber-500',
      icon: '💰',
      popular: [
        { name: 'Bookkeeping', icon: '📚' },
        { name: 'Tax Preparation', icon: '📋' },
      ...
      services: [
        {
          ...
          items: ['Bookkeeping', 'Financial Statements', 'Accounts Payable', 'Accounts Receivable']
        },
        {
          title: 'Tax Services',
          items: ['Tax Preparation', 'Tax Planning', 'Tax Consulting', 'Corporate Tax']
        },
        {
          title: 'Financial Consulting',
          items: ['Financial Analysis', 'Budget Planning', 'Investment Advice', 'Risk Assessment']
        }
      ]
    },
    legal: {
      title: 'Legal Services',
      subtitle: 'Professional legal consultants and contract specialists',
      color: 'from-gray-500 to-slate-500',
      icon: '⚖️',
      popular: [
        { name: 'Contract Drafting', icon: '📝' },
      ...
      services: [
        {
          ...
          items: ['Contract Drafting', 'Contract Review', 'NDA Preparation', 'Terms of Service']
        },
        {
          title: 'Business Legal',
          items: ['Business Formation', 'Corporate Law', 'Compliance', 'Licensing']
        },
        {
          title: 'Intellectual Property',
          items: ['Trademark Registration', 'Patent Filing', 'Copyright Protection', 'IP Consulting']
        }
      ]
    },
    hr: {
      title: 'HR & Training',
      subtitle: 'Human resources specialists and corporate trainers',
      color: 'from-teal-500 to-cyan-500',
      icon: '👥',
      popular: [
        { name: 'Recruiting', icon: '🎯' },
        { name: 'HR Consulting', icon: '💼' },
        { name: 'Employee Training', icon: '📚' },
      ...
      services: [
        {
          title: 'Recruitment',
          items: ['Talent Acquisition', 'Job Posting', 'Candidate Screening', 'Interview Coordination']
        },
        {
          title: 'HR Management',
          items: ['HR Consulting', 'Policy Development', 'Employee Relations', 'Compensation Planning']
        },
        {
          title: 'Training & Development',
          items: ['Corporate Training', 'Leadership Development', 'Onboarding Programs', 'Skills Assessment']
        }
      ]
    },
    engineering: {
      title: 'Engineering & Architecture',
      subtitle: 'Professional engineers and architects for technical projects',
      ...
      services: [
        {
          title: 'CAD & Design',
          items: ['AutoCAD', 'SolidWorks', '3D Modeling', 'Technical Drawing']
        },
        {
          title: 'Engineering',
          items: ['Structural Analysis', 'Mechanical Design', 'Electrical Engineering', 'Civil Engineering']
        },
        {
          title: 'Architecture',
          items: ['Building Design', 'Interior Design', 'Urban Planning', 'Renovation Plans']
        }
      ]
    }
  };
